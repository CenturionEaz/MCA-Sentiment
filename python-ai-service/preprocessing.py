...
def clean_text(text: str, remove_stopwords: bool = False,
    ...
    # Stopword removal (optional — not used for sentiment, used for wordcloud)
    if remove_stopwords:
...
def clean_for_wordcloud(texts: list, domain_stopwords: set = None) -> list:
    """
    Aggressive cleaning for word cloud generation.
    Removes stopwords and domain-specific filler words.
    """
    return clean_batch(texts, remove_stopwords=True,
